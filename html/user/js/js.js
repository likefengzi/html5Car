  ...
  function echarts_3() {
    ...
    setInterval(function () {
      ...
      $.ajax({
        async: false,
        type: "GET",
        url: "http://122.9.33.180:8080//getSafeBandStatus",
        data: {id:1},
        dataType: 'json',
  ...
  function echarts_5() {
    ...
    setInterval(function () {
      ...
      $.ajax({
        async: false,
        type: "GET",
        url: "http://122.9.33.180:8080//getAlarmByID",
        data: {id:1},
        dataType: 'json',
        success: function myresult(t) {
          console.log(t);
          data=t.data.alarmStatus;
  ...
  function echarts_4() {
    ...
    setInterval(function () {
      ...
      $.ajax({
        async: false,
        type: "GET",
        url: "http://122.9.33.180:8080//getLastLightValue",
        data: {},
        dataType: 'json',
        success: function myresult(t) {
          console.log(t);
